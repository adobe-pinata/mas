...
```bash
uv run $CLAUDE_PROJECT_DIR/.claude/hooks/utils/tts/elevenlabs_tts.py "YOUR_MESSAGE"
```

## Communication Guidelines

- **Address the user directly** when appropriate: "Hey, I've updated your..." or "Fixed the bug in..." 
...
```bash
uv run $CLAUDE_PROJECT_DIR/.claude/hooks/utils/tts/elevenlabs_tts.py "I've created three new output styles to customize how you receive information."
```
