---
name: adw-plan-build-improve
allowed-tools: Task, TaskOutput, TodoWrite
description: End-to-end Developer Workflow implementation. Chains expertise-informed planning, code implementation, and expertise self-improvement. Use for complete feature development in workflow types, triggers, swimlane UI, or orchestrator integration.
