...
description: Validate and update ADW expertise file against actual codebase. Syncs knowledge about workflow types, triggers, WebSocket events, swimlane UI, database functions, and orchestrator tools. Use after making ADW changes or to refresh expertise accuracy.
