---
name: qa-server-question
allowed-tools: Read, Bash, TodoWrite, Grep, Glob
description: Answer questions about QA server architecture, patterns, key files, and implementation details — without making code changes. Use when asking how actions or services work, where things live, why a pattern exists, or what a data shape looks like.
argument-hint: [question]
---

# QA Server Expert — Question Mode
...
USER_QUESTION: $1
EXPERTISE_PATH: .claude/commands/experts/qa-server/expertise.yaml
...
1. Read EXPERTISE_PATH to understand qa-server architecture and patterns
